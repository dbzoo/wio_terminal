...
//--------------------------------------------------------------------------
*/
// Wio_uncannyEyes     : rev.1 : 2020.09.29 modify by Anson He(Seeed Studio)
// https://github.com/Seeed-Studio/Seeed_Arduino_Sketchbook/tree/master/examples/WioTerminal_UncannyEyes
// Modified again by DBZOO for WIO Light Sensor and general tidy up.
...
#define IRIS_MIN         32
#define IRIS_MAX         512
#define LIGHT_PIN        WIO_LIGHT    // Photocell or potentiometer (else auto iris)
#define LIGHT_MAX        256 // upper reading from sensor
...
void setup(void) {
  ...
  pinMode(WINK_L_PIN,  INPUT_PULLUP); 
  pinMode(WINK_R_PIN, INPUT_PULLUP);
...
void drawEye( // Renders one eye.  Inputs must be pre-clipped & valid.
  ...
  tft.setAddrWindow ( e==0?1:191,56,128,128); // left=1, right=191 (x offset)
...
void loop() {
  ...
  uint16_t v = analogRead(LIGHT_PIN);// Raw dial/photocell reading (0-256)
#ifdef IRIS_PIN_FLIP
  v = (LIGHT_MAX - LIGHT_MIN) - v;
#endif
